...
import img2 from '../../images/Blog_page/1.jpg'
          ...
          <Row>
            ...
            <Col lg={12} >
              <div id='content_adi2' >
                ...
                <br />
                <h4 className='htag' >
                  <Link to='/Ad_min1' reloadDocument = {true} >  <i class="fa-solid fa-arrow-left leftl "></i>  <span className='prw' >Prev Post </span> </Link>
                  <Link to='/Ad_min3' reloadDocument = {true} > <span className='next' > Next Post</span> <i class="fa-solid fa-arrow-right rightr "> </i> </Link>
                </h4>
              </div>
