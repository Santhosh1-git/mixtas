...
import img2 from '../../images/Blog_page/5.jpg'
...
function Ad_min5() {
  return (
    <>
        ...
        <Container> 
          <div id='ad_head1'>
        <h4>Tailored Tales: Unveiling the Latest Trends in Men’s Fashion</h4>
          ...
          <Row>
            ...
            <Col lg={12} >
              <div id='content_adi2' >
                ...
                <br />
                <h4 className='htag' >
                  <Link to='/Ad_min4' reloadDocument = {true} >  <i class="fa-solid fa-arrow-left leftl "></i>  <span className='prw' >Prev Post </span> </Link>
                  <Link to='/Ad_min6' reloadDocument = {true}  > <span className='next' > Next Post</span> <i class="fa-solid fa-arrow-right rightr "> </i> </Link>
                </h4>
              </div>
