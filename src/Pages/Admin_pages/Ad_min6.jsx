...
import img2 from '../../images/Blog_page/6.jpg'
...
function Ad_min6() {
  return (
    <>
        ...
        <Container> 
          <div id='ad_head1'>
        <h4>Menswear Maven: Fashion Finds for Every Occasion  </h4>
          ...
          <Row>
            ...
            <Col lg={12} >
              <div id='content_adi2' >
                ...
                <br />
                <h4 className='htag' >
                  <Link to='/Ad_min5' reloadDocument = {true} >  <i class="fa-solid fa-arrow-left leftl "></i>  <span className='prw' >Prev Post </span> </Link>
                  <Link to='/Ad_min1' reloadDocument = {true}  > <span className='next' > Next Post</span> <i class="fa-solid fa-arrow-right rightr "> </i> </Link>
                </h4>
              </div>
